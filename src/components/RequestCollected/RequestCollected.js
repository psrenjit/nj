...
export default function SignedRequest() {
  ...
  const btnSave = async (e) => {
    ...
    try {
      const response = await axios.put(
        `${config.BASE_URL}/request-recived/request-recived-update.php`,
        data,
        {
  ...
  disabled={!(us.requestnossigneddate && !us.requestnosreqcoldate)} // Enable only if signeddate is true and requestnossigneddate is false
